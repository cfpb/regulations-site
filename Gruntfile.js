module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    recess: {
      dist: {
        src: ['<%= banner %>', 'front_end/css/font-awesome.css', 'front_end/css/normalize.css', 'front_end/css/fonts.css', 'front_end/css/main.less', 'front_end/css/print.css','!front_end/css/*.min.css'],
