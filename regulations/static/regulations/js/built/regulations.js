...
define("underscore", ["jquery"], (function (global) {
    return function () {
        var ret, fn;
        return ret || global._;
    };
...
(function (root, factory) {
   if (typeof exports === 'object' && root.require) {
     module.exports = factory(require("underscore"), require("backbone"));
      ...
      define('queryparams',["underscore","backbone"], function(_, Backbone) {
...
define("jquery-scrollstop", ["jquery"], function(){});
...
define('drawer-tabs-view',['jquery', 'underscore', 'backbone', 'drawer-events', 'ga-events'], function($, _, Backbone, DrawerEvents, GAEvents) {
    'use strict';
...
define("konami", (function (global) {
    return function () {
        var ret, fn;
        return ret || global.Konami;
    };
}(this)));
